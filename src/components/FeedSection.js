  ...
  return (
    <div className="w-[30rem] max-xs:w-[22rem] max-xs:ml-[4rem] max-xxs:ml-0 h-auto my-8 flex flex-col items-center justify-start gap-y-6">
      {feedData.map((data, index) => {
        return (
          <div
            className="flex flex-col w-full border-b border-gray-300 gap-y-3 pb-4"
            key={index}
          >
            ...
            <div className="w-full flex items-center justify-between text-2xl">
              <div className="flex gap-x-3 items-center">
                <span
                  className={`${data.likeColor} cursor-pointer`}
                  onClick={() => {
                    handleLikeClick({ index });
                  }}
                >
                  {" "}
                  {data.likeColor === "text-black" ? (
                    <FaRegHeart />
                  ) : (
                    <FaHeart />
                  )}
                ...
                <span
                  className={`${data.commentColor} cursor-pointer text-[]`}
                  onClick={() => {
                    handleCommentClick({ index });
                  }}
                >
                  {" "}
                  {data.commentColor === "text-black" ? (
                    <TbMessageCircle2 />
                  ) : (
            ...
            <div className="w-full flex flex-col gap-y-1">
              ...
              <div
                className={`w-full flex flex-col text-sm gap-y-1 mt-2 ${data.commentsVisibility} `}
              >
                ...
                <form
                  className="w-full h-6 flex text-xs px-0"
                ...
                >
                  ...
                  />
                  <button className="w-6 text-blue-400 font-bold" type="submit">
                    Post
                  </button>
                </form>
              </div>
