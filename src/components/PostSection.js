  ...
  return createPortal(
    <div className="z-1 w-full h-22 fixed flex top-0 bottom-0 bg-black bg-opacity-60 items-center justify-center">
      <div className="w-[30rem] h-[25rem] bg-white flex flex-col items-start">
        <button
          className="flex items-center justify-end w-full p-1 text-2xl text-gray-400"
          onClick={closePostSection}
        >
          <IoClose />
        </button>
          ...
          <div className="w-full flex flex-col items-center justify-center gap-y-4 -mt-6">
            ...
            <div className="flex flex-col gap-y-2 items-center text-sm">
              ...
              <input
                ...
                className="w-64 h-6 px-2 rounded-lg outline-none border border-blue-400 text-xs text-gray-700"
