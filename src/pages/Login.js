...
const Login = () => {
  ...
  const authStatus = useSelector(
    (store) => store.signInDetails.isAuthenticated
  );
        ...
        <div className="w-[22rem] h-full flex flex-col items-center justify-center gap-y-3">
          <div className=" w-full h-2/3 border border-gray-300 flex flex-col items-center justify-center px-10">
            ...
            <div className="w-full flex flex-col gap-y-4">
              ...
              <button
                className="w-full rounded-lg bg-blue-400 h-8 text-sm font-semibold text-white"
                onClick={handleLogin}
              >
                Log in
              </button>
              <div
                className={`text-xs h-1 flex w-full justify-center items-center text-[#FD1D1D] ${visibility}`}
              >
                username or paswword is incorrect.
              </div>
              <div className="flex items-center justify-center text-sm font-semibold tracking-wide">
                OR
              </div>
              <div className="flex items-center justify-center text-sm font-semibold tracking-wide text-blue-900">
                Log in with Facebook
              </div>
              <div className="flex items-center justify-center text-xs tracking-wide text-blue-900">
